...
With that, the PIXELAV tooling (`analysis/pixelav/`, `setup/setup_pixelav.sh`,
`sim/make_pixelav_inputs.sh`, notebooks 05c + 06, this log and `pixelav_handoff.md`) was ported
from the `pixelav-integration` branch onto `main`.
