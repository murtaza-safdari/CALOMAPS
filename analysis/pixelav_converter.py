...
One record per charged-track sensor crossing. PRIMARY = Variant C (auto-selected):
...
# Used by the notebook-07 schematic.
...
# ==========================================================================================
# Variant A -- per-sensor crossings from time-ordered Geant4 step-level truth
# ==========================================================================================
